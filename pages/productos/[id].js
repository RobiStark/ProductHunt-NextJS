...
const Producto = () => {
    ...
    const votarProducto = () => {
        ...
        guardarConsultarDB(true); //Hay un voto por lo tanto cunsultar a la BD
    } 
    ...
    const agregarComentario = e => {
        ...
        guardarConsultarDB(true); //Hay un comentario por lo tanto cunsultar a la BD
    }
